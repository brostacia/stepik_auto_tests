...
try: 
    ...
    input_name = browser.find_element(By.CSS_SELECTOR, "input[placeholder='Input your name']")
    input_name.send_keys('info')

    input_last_name = browser.find_element(By.CSS_SELECTOR, "input[placeholder='Input your last name']")
    input_last_name.send_keys('info')

    input_email = browser.find_element(By.CSS_SELECTOR, "input[placeholder='Input your email']")
    input_email = input_email.send_keys('info')
